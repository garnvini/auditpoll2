    ...
    ?>
      ...
      <div class="content-wrapper">
        ...
        ?>
            ...
            <a href="auditor_addform.php" class="btn btn-info">เพิ่มแบบประเมิน</a><br><br>
          <!-- Default box -->
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id = "table" 
                     data-toggle="table" 
                     data-url="./json/questionaire_json.php" 
                    ...
                    <thead>
                        ...
                        <th data-field="questionaireID">ลำดับที่</th>
                        <th data-field="questionaireName">ชื่อแบบประเมิน</th>
             ...
             $.smkConfirm({text:'แน่ใจว่าต้องการลบข้อมูล',accept:'ตกลง', cancel:'ยกเลิก'},function(e){
                ...
                if (e) {
                  var ids = $.map($table.bootstrapTable('getSelections'), function(row){
                      return row.questionaireID;
                  });
                  
                  //ajax
                  $.get("questionaire_del.php", {"questionaireID[]": ids} )
                        .done(function(data){
   ...
   function operateFormatter(value, row, index) {
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            window.location.replace('questionaire_editform.php?questionaireID=' + [row.questionaireID]);
        },
