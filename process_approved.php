    ...
    ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            กระบวนการที่อนุมัติแล้ว
          </h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
            <li><a href="#">กระบวนการที่อนุมัติแล้ว</a></li>
          </ol>
        ...
        ?>
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">ข้อมูลกระบวนการที่อนุมัติแล้ว</h3>
            ...
            <div class="box-body">
              ...
              <table id = "table" 
                     data-toggle="table" 
                     data-url="./json/process_json3.php" 
                    ...
                    <thead>
                        ...
                        <th data-field="approveDate">วันที่อนุมัติการออกตรวจ</th>
                        <th data-field="userFullname">ผู้อนุมัติ</th>
