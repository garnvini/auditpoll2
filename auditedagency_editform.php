 ...
 <?php include 'header.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
            แก้ไขข้อมูลหน่วยรับตรวจ
      </h1>
      <ol class="breadcrumb">
          <li><a href="auditedagency.php"><i class="fa fa-dashboard"></i> ข้อมูลหน่วยรับตรวจ</a></li>
        <li class="active">แก้ไขข้อมูลหน่วยรับตรวจ</li>
      </ol>
    </section>
      ...
      <!-- Your Page Content Here -->
        <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">แก้ไขข้อมูลหน่วยรับตรวจ</h3>
