    ...
    ?>
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>ผลการประเมินรายทีม</h1>
          <ol class="breadcrumb">
              <li><a href="evaluateteam.php"><i class="fa fa-dashboard"></i> ผลการประเมินรายทีม</a></li>
            <li><a href="#">รายละเอียผลการประเมินรายทีม</a></li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <?php    
                ...
                while ($row_fy = mysqli_fetch_assoc($result_fy)) { 
                    ...
                    echo '<h3>ผลการประเมินการปฏิบัติงาน ปีงบประมาณ ' . $fy . '</h3><hr>';
                    echo '<div class="row">';
                    // แยกทีม
                    $sql_team = "SELECT * FROM team WHERE team.teamID = '$teamID'";
                    ...
                    while ($row_team = mysqli_fetch_assoc($result_team)) {                         
                        ...
                        echo '</div><div class = "col-md-12"><br></div>'; //col-md-12
