  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">ผลการประเมินรายบุคคล</a></li>
          </ol>
        ...
        ?>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id = "table" 
                     data-toggle="table" 
                     data-url="./json/scoreperson_resultind_json.php" 
                    ...
                    <thead>
                        <tr>
                        <th data-width="80" data-field="auditorPicture" data-formatter="imageFormatter">รูป</th>
                        ...
                        <th data-field="jobSynName">งาน</th>
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row, index) {
            window.location.replace('evaluateperson_detail.php?auditorID=' + [row.auditorID]);
        },
