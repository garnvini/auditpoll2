    ...
    ?>
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
              <li><a href="scoreperson_resultind.php"><i class="fa fa-dashboard"></i> ผลการประเมินรายบุคคล</a></li>
            <li><a href="#">รายละเอียดผลการประเมินรายบุคคล</a></li>
          </ol>
        </section>
                ...
                while ($row_fy = mysqli_fetch_assoc($result_fy)) { 
                    ...
                    echo '<h3>ผลการประเมินการปฏิบัติงาน ปีงบประมาณ ' . $fy . '</h3>';
                        ...
                        $sql_head = "SELECT auditorPre, auditorName, "
                                ...
                                . "FROM auditor WHERE auditorID = '$auditorID'";
